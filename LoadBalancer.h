...
class LoadBalancer {
    ...
    public:
        ...
        /**
         * @brief Returns the total number of requests that have been generated by the load balancer.
         * @return The total number of generated requests.
         */
        int getGeneratedRequests();
        
        /**
         * @brief Returns the total number of requests that have been processed by the load balancer.
         * @return The total number of processed requests.
         */
        int getProcessedRequests();
        
        /**
         * @brief Returns the total number of requests that have been blocked by the IP blocker.
         * @return The total number of blocked requests.
         */
        int getBlockedRequests();

        /**
         * @brief Returns the total number of servers that have been added to the load balancer.
         * @return The total number of added servers.
         */
        int getServersAdded();

        /**
         * @brief Returns the total number of servers that have been removed from the load balancer.
         * @return The total number of removed servers.
         */
        int getServersRemoved();

        /**
         * @brief Returns the maximum size of the request queue that has been observed during the operation of the load balancer.
